...
def main():
    ...
    test_data = open("data_feature/test_data_feature_pos_500.pkl", "rb")
    ...
    train_data = open("data_feature/train_data_feature_pos_1000.pkl", "rb")
